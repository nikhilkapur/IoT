# COde obtained from https://electrosome.com/hc-sr04-ultrasonic-sensor-raspberry-pi/
...
class DistanceMeasurer:
    ...
    def __init__(self, trig_pin, echo_pin, settle_time=1, range_min=2, range_max=500):
